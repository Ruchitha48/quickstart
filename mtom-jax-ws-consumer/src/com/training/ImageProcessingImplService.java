 ...
 * 
 */
@WebServiceClient(name = "ImageProcessingImplService", targetNamespace = "http://services.training.com/", wsdlLocation = "http://localhost:4000/images?WSDL")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("http://localhost:4000/images?WSDL");
